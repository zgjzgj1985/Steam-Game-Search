...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center gap-1 rounded-xl p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, icon, label, children, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-[#66c0f4] data-[state=active]:text-[#0f1923] data-[state=active]:shadow-sm",
